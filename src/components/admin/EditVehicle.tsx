...
import { Save, UploadCloud, CheckCircle2, ArrowLeft } from 'lucide-react';
      ...
      <div className="p-8 max-w-5xl mx-auto border-l-4 border-gray-900 border-r-4 border-r-gray-900 bg-white shadow-[8px_8px_0_0_rgba(0,0,0,1)]">
        ...
        <div className="flex justify-between items-center mb-8 border-b-4 border-gray-900 pb-4">
          <h1 className="text-3xl font-black text-gray-900 uppercase tracking-tight flex items-center">
             Edit Vehicle <span className="ml-4 bg-gray-100 text-gray-800 text-sm px-3 py-1 border-2 border-gray-800">{id || 'V-101'}</span>
          </h1>
        </div>
        ...
        {success && (
          <div className="mb-8 bg-green-50 border-l-4 border-green-500 p-4 flex items-center">
            ...
            <div>
               <p className="text-sm font-bold text-green-900 uppercase tracking-wider">Vehicle updated successfully</p>
            </div>
          </div>
        )}
        ...
        <form onSubmit={handleSave} className="space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
             <div>
                 ...
                 <input type="text" required defaultValue="Toyota" className="w-full bg-gray-50 border-2 border-gray-200 text-gray-900 text-sm font-bold p-3 focus:ring-0 focus:border-red-600 transition-colors" />
             </div>
             <div>
                 <label className="block text-xs font-bold text-gray-500 uppercase tracking-widest mb-2">Model</label>
                 <input type="text" required defaultValue="Camry 2023" className="w-full bg-gray-50 border-2 border-gray-200 text-gray-900 text-sm font-bold p-3 focus:ring-0 focus:border-red-600 transition-colors" />
             </div>
             <div>
                 <label className="block text-xs font-bold text-gray-500 uppercase tracking-widest mb-2">Year</label>
                 <input type="number" required defaultValue="2023" min="2000" max="2100" className="w-full bg-gray-50 border-2 border-gray-200 text-gray-900 text-sm font-bold p-3 focus:ring-0 focus:border-red-600 transition-colors" />
             </div>
             <div>
                 <label className="block text-xs font-bold text-gray-500 uppercase tracking-widest mb-2">Registration Plate</label>
                 <input type="text" required defaultValue="GR-1234-24" className="w-full bg-gray-50 border-2 border-gray-200 text-gray-900 text-sm font-bold p-3 focus:ring-0 focus:border-red-600 transition-colors uppercase" />
             </div>
          </div>
          ...
          <div className="bg-gray-50 p-6 border-2 border-gray-200">
             <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                    ...
                    <select required defaultValue="Sedan" className="w-full bg-white border-2 border-gray-300 text-gray-900 text-sm font-bold p-3 focus:ring-0 focus:border-red-600 transition-colors appearance-none">
                ...
                <div>
                    ...
                    <select required defaultValue="Economy" className="w-full bg-white border-2 border-gray-300 text-gray-900 text-sm font-bold p-3 focus:ring-0 focus:border-red-600 transition-colors appearance-none">
          ...
          <div className="border-t-2 border-gray-200 pt-6">
             <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
               <div>
                    ...
                    <select required defaultValue="Petrol" className="w-full bg-gray-50 border-2 border-gray-200 text-gray-900 text-sm font-bold p-3 focus:ring-0 focus:border-red-600 transition-colors appearance-none">
                ...
                <div>
                    ...
                    <select required defaultValue="Automatic" className="w-full bg-gray-50 border-2 border-gray-200 text-gray-900 text-sm font-bold p-3 focus:ring-0 focus:border-red-600 transition-colors appearance-none">
          ...
          {/* Photos */}
          <div>
              <label className="block text-xs font-bold text-gray-500 uppercase tracking-widest mb-4">Vehicle Photos</label>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                 <div className="bg-gray-100 aspect-video relative group">
                    <img src="https://images.unsplash.com/photo-1550355291-bbee04a92027?auto=format&fit=crop&q=80&w=400" alt="Car" className="w-full h-full object-cover" />
                    <button type="button" className="absolute top-2 right-2 bg-red-600 text-white p-1 text-xs opacity-0 group-hover:opacity-100 transition-opacity">Remove</button>
                    <div className="absolute bottom-2 left-2 bg-gray-900 text-white px-2 py-0.5 text-xs font-bold uppercase tracking-wider">Primary</div>
                 </div>
                 <div className="bg-gray-100 aspect-video relative group">
                    <img src="https://images.unsplash.com/photo-1549317661-bd32c8ce0db2?auto=format&fit=crop&q=80&w=400" alt="Car Interior" className="w-full h-full object-cover" />
                    <button type="button" className="absolute top-2 right-2 bg-red-600 text-white p-1 text-xs opacity-0 group-hover:opacity-100 transition-opacity">Remove</button>
                 </div>
              </div>
              <div className="border-2 border-dashed border-gray-300 p-6 text-center bg-gray-50 hover:bg-gray-100 transition-colors cursor-pointer">
                  <UploadCloud className="w-8 h-8 text-gray-400 mx-auto mb-2" />
                  <p className="text-sm font-bold text-gray-700">Add More Photos</p>
              </div>
          </div>
