          ...
          <div className={`grid md:grid-cols-2 gap-8 mb-12 ${isStale ? 'opacity-50 grayscale' : ''}`}>
            ...
            <div className="bg-gray-50 border border-gray-200 p-6 flex flex-col justify-between">
              ...
              <div className="mt-6 flex justify-end">
                <img src="https://images.unsplash.com/photo-1549317661-bd32c8ce0db2?auto=format&fit=crop&q=80" alt="Vehicle Placeholder" className="w-48 h-24 object-cover border border-gray-200 shadow-sm" />
              </div>
            </div>
