...
export default function VehicleDetail() {
  ...
  const vehicle = {
    ...
    images: [
      'https://images.unsplash.com/photo-1590362891991-f776e747a588?auto=format&fit=crop&q=80&w=1200', // Generic sedan front
      'https://images.unsplash.com/photo-1549317661-bd32c8ce0db2?auto=format&fit=crop&q=80&w=1200', // Interior
      'https://images.unsplash.com/photo-1550355291-bbee04a92027?auto=format&fit=crop&q=80&w=1200'  // Generic back
    ],
    specs: {
      passengers: 4,
      luggage: 3,
