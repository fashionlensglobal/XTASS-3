  ...
  return (
    <main className="flex-grow bg-gray-50 pb-24">
      ...
      <section className="bg-brand-maroon pb-20 pt-16 relative">
        <div className="absolute inset-0 opacity-10 bg-[url('https://images.unsplash.com/photo-1549317661-bd32c8ce0db2?auto=format&fit=crop&q=80')] bg-cover bg-center mix-blend-overlay"></div>
      ...
      <section className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-white border border-gray-200 shadow-sm hover:shadow-lg transition-shadow overflow-hidden flex flex-col">
            <img src="https://images.unsplash.com/photo-1449965408869-eaa3f722e40d?auto=format&fit=crop&q=80" alt="One-Way Rental" className="h-48 w-full object-cover" />
          ...
          {/* Long-Term */}
          <div className="bg-white border border-gray-200 shadow-sm hover:shadow-lg transition-shadow overflow-hidden flex flex-col">
            <img src="https://lh3.googleusercontent.com/aida-public/AB6AXuC3qxOUS8e8A1Tbw0GD8r9YPbAqaBxnJTH4yhAjmNZTXeI7iC_G22v36QiFCV9W0c-JR5tW0q0Hgvw2igSGTl4-J1xrYAnQEsn03GrwO2Rwd5CaAyRglD_ejjdpOKMBXVy4vFPW21C1PVOQqSfswgQ0h4qkrrDH9kDVfIDH9vDrCH9CAR4YEWqbMAJDGVWvFJVxHDsEhDHUifigQbnF1Mb1zL4qCGiuQE-xJ0CYyKy9WorbduZFascr4HmIYSkaeT44aFgWWGVwWV0" alt="Long-Term Rental" className="h-48 w-full object-cover" />
            <div className="p-6 flex-grow flex flex-col">
          ...
          {/* Weekend */}
          <div className="bg-white border border-gray-200 shadow-sm hover:shadow-lg transition-shadow overflow-hidden flex flex-col">
            <img src="https://images.unsplash.com/photo-1523987355523-c7b5b0dd90a7?auto=format&fit=crop&q=80" alt="Weekend Rental" className="h-48 w-full object-cover" />
            <div className="p-6 flex-grow flex flex-col">
