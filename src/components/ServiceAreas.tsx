        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-gray-100 h-full min-h-[300px] rounded border border-gray-200 shadow-inner p-8 flex items-center justify-center">
               <img src="https://images.unsplash.com/photo-1628155930542-3c7a64e2c848?auto=format&fit=crop&q=80" alt="Accra Cityscape" className="w-full h-full object-cover rounded shadow-md" />
            </div>
          </div>
        </div>
      </section>
